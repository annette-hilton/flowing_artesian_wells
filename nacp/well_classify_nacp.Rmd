...
nacp_mod_fromarc <- readr::read_csv(here::here("data", "nacp", "nacp_mod_classify_052722.txt")) %>% 
  clean_names() %>% 
...
kable(early1900s_final_table, caption = "Table 2. Early 1900s confined and artesian wells of the North Atlantic Coastal Plain")
```
### Visualization 
...
```{r}
# Modern 
mod_art <- nacp_confined_mod %>% 
  count(artesian) 


# Historical 
hist_art <- nacp_confined_1900 %>% 
  count(artesian)
```
