...
# save (test) confined only 

confined_original_1900 <- confined_criteria_1900 %>% 
  filter(status == "confined")

write_tsv(confined_original_1900, here::here("output_data", "cv", "confined_1900_original.txt"))
