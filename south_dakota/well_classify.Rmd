...
2. Modern wells from SD (combination of drilling wells, observation wells, and USGS wells) (processed in Rmd `sd_modern_data_cleaning.Rmd`) and early 1900s data (early1900s_dem_wgs84_final.txt)
...
write_tsv(modern_sd, here::here("output_data", "sd", "modern_sd.txt"))
...
write_tsv(modern_sd_tb, here::here("output_data", "sd", "modern_sd_tb.txt"))
