...
```{r, fig.cap= 'Figure 1. Roswell Artesian Basin aerial extent (Land and Newton, 2008)', fig.align='center', output.width= "200px", echo= FALSE}

knitr::include_graphics(here::here("images", "roswell_aerial.png"))

```

```{r, fig.cap= 'Figure 2. Roswell Artesian Basin cross section (Land and Newton, 2008)', fig.align='center', output.width= "400px", echo= FALSE}
...
kable(early1900s_final_table, caption = "Table 2. Early 1900s confined and artesian wells of the Roswell Artesian Basin")
```
...
```{r}
# Modern 
mod_art <- modern_roswell_artesia %>% 
  count(artesian) 


# Historical 
hist_art <- historical_roswell_artesia %>% 
  count(artesian)
```
