...
fl_analysis_mod_2 <- fl_analysis_mod %>% 
  ...
  select(site_no, dec_lat_va, dec_long_va, well_depth_va,lev_va,
         level_date, level_year, x, rastervalu, topo_ft, 
...
write_tsv(summary_me, here::here("fl_data", "summary_me.txt"))
