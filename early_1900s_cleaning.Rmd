...
# Remove any duplicates (duplicates generated in ArcGIS process) 

early1900s_dem_tidy <- early1900s_dem %>% 
  select(id, ned10m_bilinear_cusa_albers102003) %>% 
  distinct(id, .keep_all = TRUE)

# Remove duplicates from metadata file (duplicates somehow generated in the ArcGIS process) 

early1900s_arc_tidy <- early1900s_arc %>% 
  distinct(id, .keep_all = TRUE)

# Join with metadata file/full 1900s file 

early1900s_final <- early1900s_dem_tidy %>% 
  full_join(early1900s_arc_tidy, by = "id") 
